...
func main() {
	...
	// Générer un nombre entier aléatoire entre 0 et 100 inclus
	rand.Seed(time.Now().UnixNano())
	randomNumber = rand.Intn(101)

	if randomNumber%2 == 0 {
		fmt.Println("Le chiffre est pair:", randomNumber)
	} else {
		fmt.Println("Le chiffre est impair:", randomNumber)
	}
}
